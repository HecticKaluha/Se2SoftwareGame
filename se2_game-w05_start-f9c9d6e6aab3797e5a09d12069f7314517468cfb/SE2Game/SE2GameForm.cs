...
namespace SE2Game
{
    public partial class SE2GameForm : Form
    {
        ...
        {
            InitializeComponent();
            CBAI.Items.Add("LogicRandom");
            CBAI.Items.Add("AiMoveSpeedy");
            CBAI.Items.Add("Random");
            CBAI.SelectedIndex = 1;
        ...
        {
            World.Instance.Create(picGameWorld.ClientSize, (int)NUDEnemies.Value, (string)CBAI.SelectedItem);
            picGameWorld.Refresh();
        }
    }
}
